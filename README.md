...
I love creating clean UI with **React, Tailwind, and Bootstrap**, and building powerful backend systems using **Node.js, Express, and PostgreSQL**.
...
**Tools & Others:**  
🧰 Git • GitHub • VS Code • REST APIs • JSON • npm  
...
- Scalable APIs and database design  
...
|----------|--------------|-------------|
| 🛒 **E-Commerce Platform** | Full-stack shopping website with cart and payments | React, Node.js, PostgreSQL, Tailwind |
| 🏫 **University Management System** | Manage students, courses, and results online | React, Express, PostgreSQL |<h1 align="center">Awesome GitHub Profile README
...
| 💼 **Portfolio Website** | Personal responsive portfolio and blog | HTML, CSS, Bootstrap |
...
⭐️ *Feel free to explore my projects, fork repositories, or connect with me for collaboration!*
